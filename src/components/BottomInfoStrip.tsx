const BottomInfoStrip = () => (
  <div className="fixed bottom-0 left-0 right-0 z-40 bg-red-600 text-white shadow-[0_-3px_10px_rgba(0,0,0,0.15)] md:static md:shadow-none">
    <div className="mx-auto flex h-12 max-w-7xl items-center justify-between gap-2 px-3 text-[11px] font-semibold sm:text-xs md:h-14 md:px-6 md:text-sm">
      <a href="tel:+916387236091" className="whitespace-nowrap hover:opacity-90">
        +91-6387236091
      </a>
      <span className="truncate text-center">100% Guaranteed Placement</span>
      <button
