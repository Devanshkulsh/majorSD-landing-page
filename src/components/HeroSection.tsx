      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-16 md:py-16 lg:py-24">
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-center lg:items-start">
          ...
          <motion.div 
            ...
            animate="visible"
          >
            <motion.div variants={item} className="inline-block bg-white/10 backdrop-blur-md border border-white/20 rounded-full px-4 py-1.5 sm:px-5 sm:py-2 text-[11px] sm:text-xs md:text-sm font-medium mb-6 sm:mb-8 shadow-sm">
              🚀 New Launch | Batch 2026
            </motion.div>

            <motion.h1 variants={item} className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-extrabold leading-[1.15] md:leading-tight lg:leading-tight mb-4 sm:mb-6">
              BBA in <span className="text-secondary">Artificial Intelligence</span>
            </motion.h1>

            <motion.h2 variants={item} className="text-base sm:text-xl md:text-2xl font-medium text-white/90 mb-4 sm:mb-6 px-2 sm:px-0">
              Shape the Future of Business with the Power of AI
            </motion.h2>

            <motion.p variants={item} className="text-sm sm:text-base md:text-lg text-white/80 mb-8 sm:mb-10 max-w-2xl leading-relaxed px-2 sm:px-0">
            ...
            <motion.div variants={item} className="flex flex-wrap justify-center lg:justify-start gap-2 sm:gap-3 mb-8 sm:mb-10 w-full">
              {highlights.map((h) => (
                <span 
                  key={h.text} 
                  className={
            ...
            <motion.div variants={item} className="flex flex-col sm:flex-row w-full sm:w-auto justify-center lg:justify-start gap-3 sm:gap-4 mb-8 sm:mb-10">
              <button
            ...
            <motion.div variants={item} className="flex flex-row items-center justify-center lg:justify-start gap-2 text-xs sm:text-sm md:text-base text-white/80 bg-white/5 px-5 py-2.5 rounded-full w-max mx-auto lg:mx-0">
              <span className="text-secondary tracking-widest text-[10px] sm:text-sm">★★★★★</span>
